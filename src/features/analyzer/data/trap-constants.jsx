...
export const TRAPS = {
  egotism: {
    ...
    reframe:
      "The world isn't wrong; your map is outdated. Humility is the only way to get your vision back.",
    symptoms: [
    ...
    playbook: [
      {
        ...
        prompt: 'List only observable facts. No blame language. What is actually in front of you?'
      },
      {
        type: 'action',
        time: 420,
        label: 'The Manual Ritual',
        prompt: 'Find the source of truth (docs, email, message). Read it assuming YOU are wrong.'
      },
      {
        type: 'write',
        time: 300,
        label: 'One Correction',
        prompt: 'What is the smallest thing you can test to prove yourself wrong?'
      },
      {
        type: 'log',
        time: 60,
        label: 'Close Loop',
        prompt: 'What did reality tell you when you stopped defending yourself?'
      }
    ]
  },
  anxiety: {
    ...
    description:
      'Fear of low quality. You are paralyzed because you care too much about the outcome.',
    ...
    playbook: [
      {
        ...
        time: 120,
        label: 'Name the Fear',
        prompt: 'What specific bad thing happens if you start?'
      },
      {
        type: 'write',
        time: 300,
        label: 'Shrink the Task',
        prompt: 'Break the first step into 3 micro-steps. Pick one.'
      },
      {
        type: 'action',
        time: 600,
        label: 'Dry Run',
        prompt: 'Do Step 1 in a sandbox (draft, scratchpad). No consequences.'
      },
      {
        type: 'timer',
        time: 180,
        label: 'Timebox',
        prompt: 'Work for just 3 minutes. The only goal is to touch the task.'
      }
    ]
  },
  impatience: {
    ...
    playbook: [
      {
        ...
        time: 120,
        label: 'Speed Check',
        prompt: 'What will I miss if I rush? List risks.'
      },
      {
        type: 'write',
        time: 180,
        label: 'Small Batch',
        prompt: 'Break the work into one verifiable change.'
      },
      {
        type: 'timer',
        time: 300,
        label: 'Low-Hassle Step',
        prompt: 'Do a single small step with no side-effects.'
      },
      {
        type: 'log',
        time: 60,
        label: 'Result Check',
        prompt: 'What happened after the small step? Did it change anything?'
      }
    ]
  },
  boredom: {
    ...
    playbook: [
      {
        type: 'branch',
        label: 'Diagnostic Fork',
        prompt: 'Are you physically tired or just bored?',
        options: [
    ...
    playbook: [
      {
        ...
        time: 180,
        label: 'Done State',
        prompt: 'Write a one-sentence definition of Done.'
      },
      {
        type: 'write',
        time: 180,
        label: 'Acceptance Criteria',
        prompt: 'List the smallest testable criteria for Done.'
      },
      {
        type: 'action',
        time: 300,
        label: 'One Measure',
        prompt: 'Pick a single metric or condition that shows progress.'
      },
      {
        type: 'log',
        time: 60,
        label: 'Share & Confirm',
        prompt: 'Share the plan with a peer and capture feedback.'
      }
    ]
  },
  intermittent: {
    ...
    playbook: [
      {
        ...
        time: 300,
        label: 'Fault Log',
        prompt: 'Create a log: Time, Context, Symptom. Do not fix.'
      },
      {
        type: 'action',
        time: 300,
        label: 'Observation Mode',
        prompt: 'Decide to only watch for the next 3 occurrences. Remove pressure to solve.'
      },
      {
        type: 'action',
        time: 600,
        label: 'Instrument',
        prompt: 'Add logging, screenshots, or recording tools.'
      },
      {
        type: 'write',
        time: 60,
        label: 'Schedule',
        prompt: 'When will you review the data? Set a time.'
      }
    ]
  },
  reassembly: {
    ...
    playbook: [
      {
        ...
        time: 300,
        label: 'Clear Space',
        prompt: 'Clear a single work zone. Move the mess to the edges.'
      },
      {
        type: 'action',
        time: 900,
        label: 'Group Components',
        prompt: 'Sort pieces into related piles. Do not assemble yet.'
      },
      {
        type: 'action',
        time: 600,
        label: 'Visual Logic',
        prompt: 'Find a diagram or sketch the "Done" state.'
      },
      {
        type: 'write',
        time: 300,
        label: 'Checkpoint',
        prompt: 'Define "Good Enough" state 1. Build only to there.'
      }
    ]
  }
}

export const CONTEXTS = ['Work', 'Relationships', 'Learning', 'Maintenance', 'Creative', 'Health']
